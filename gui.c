...
"Boost Plugin\n"
"By Johan Levin 1999.\n\n"
"Surround boost by Carl van Schaik 1999";
...
void boost_configure(void)
{
	...
	boost_volume_adj = (GtkAdjustment *) gtk_adjustment_new(boost_volume, 0, 100
	 + 10, 2, 10, 10);
	boost_cutoff_adj = (GtkAdjustment *) gtk_adjustment_new(boost_cutoff,
         MIN_CUTOFF, MIN_CUTOFF * 10 + 10, 2, 10, 10);
